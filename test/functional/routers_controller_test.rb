...
class RoutersControllerTest < ActionController::TestCase
  ...
  test "should create router" do
    assert_difference('Router.count') do
      post :create, router: { address: @router.address, password: @router.password, username: @router.username, wired: @router.wired, wireless: @router.wireless }
    end
  ...
  test "should update router" do
    put :update, id: @router, router: { address: @router.address, password: @router.password, username: @router.username, wired: @router.wired, wireless: @router.wireless }
    assert_redirected_to router_path(assigns(:router))
  end
