...
class MacsControllerTest < ActionController::TestCase
  ...
  test "should create mac" do
    assert_difference('Mac.count') do
      post :create, mac: { address: @mac.address, description: @mac.description, name: @mac.name, owner: @mac.owner }
    end
  ...
  test "should update mac" do
    put :update, id: @mac, mac: { address: @mac.address, description: @mac.description, name: @mac.name, owner: @mac.owner }
    assert_redirected_to mac_path(assigns(:mac))
  end
